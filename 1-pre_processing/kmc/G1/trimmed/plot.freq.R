setwd("/home/478358/WORKING/G_turnbulli/kmc/G1/trimmed")

data = read.table("G1-trimmed-k21.hist.txt", sep="\t", col.names=c("kmer_cov","count"))

sample="G1-trimmed"
kmer_size=21
cum_read_length=4538111653
avg_read_length=125.68
