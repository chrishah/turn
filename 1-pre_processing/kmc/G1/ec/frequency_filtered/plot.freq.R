setwd("/home/478358/WORKING/G_turnbulli/kmc/G1/ec/frequency_filtered")

data = read.table("G1-ec-filtered-k21.hist.txt", sep="\t", col.names=c("kmer_cov","count"))

sample="G1-ec-filtered"
kmer_size=21
cum_read_length=1594788498
avg_read_length=125.78
