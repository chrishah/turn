setwd("/home/478358/WORKING/G_turnbulli/kmc/G4/trimmed")

data = read.table("G4-trimmed-k21.hist.txt", sep="\t", col.names=c("kmer_cov","count"))

sample="G4-trimmed"
kmer_size=21
cum_read_length=5208689991
avg_read_length=125.63
