setwd("/home/478358/WORKING/G_turnbulli/kmc/G14/ec_batches/filter_by_kmer/gt15x_lt65-gt0.9/kmer_distribution")

data = read.table("G14-ec-G4-filtered-k31-kgt15-klt65-pgt0.9-plt1.0-k31.hist.txt", sep="\t", col.names=c("kmer_cov","count"))

sample="G14-ec-G4-filtered-k31-kgt15-klt65-pgt0.9-plt1.0"
kmer_size=31
cum_read_length=3232334302
avg_read_length=125.77
