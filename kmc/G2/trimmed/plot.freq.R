setwd("/home/478358/WORKING/G_turnbulli/kmc/G2/trimmed")

data = read.table("G2-trimmed-k21.hist.txt", sep="\t", col.names=c("kmer_cov","count"))

sample="G2-trimmed"
kmer_size=21
cum_read_length=6454522262
avg_read_length=125.64
