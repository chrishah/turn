setwd("/home/478358/WORKING/G_turnbulli/kmc/G14/ec_batches/filter_by_kmer/gt15x_gt0.9/kmer_distribution")

data = read.table("G14-ec-G4-filtered-kgt15-pgt0.9-plt1.0-k31.hist.txt", sep="\t", col.names=c("kmer_cov","count"))

sample="G14-ec-G4-filtered-kgt15-pgt0.9-plt1.0"
kmer_size=31
cum_read_length=5794306719
avg_read_length=125.69
